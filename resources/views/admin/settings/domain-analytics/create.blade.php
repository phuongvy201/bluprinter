...
@section('title', 'Thêm cấu hình Google Analytics cho Domain')

@section('content')
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Thêm cấu hình Google Analytics cho Domain</h1>
        <p class="text-gray-600">
            Tạo cấu hình Google Analytics riêng cho một domain cụ thể.
        </p>
    </div>

    <div class="bg-white shadow-md rounded-2xl overflow-hidden">
        <form method="POST" action="{{ route('admin.settings.domain-analytics.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
