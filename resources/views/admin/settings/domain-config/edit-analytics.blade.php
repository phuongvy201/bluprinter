...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Chỉnh sửa cấu hình Google Analytics</h1>
            <p class="text-gray-600">
                Cập nhật GA/GTM cho domain: <strong>{{ $config->domain }}</strong>
            </p>
        </div>
        <a href="{{ route('admin.settings.domain-config.index') }}"
           class="inline-flex items-center px-4 py-2 rounded-xl border border-gray-300 text-gray-700 hover:bg-gray-50 transition">
            Quay lại danh sách
        </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-2xl overflow-hidden">
        <form method="POST"
              action="{{ route('admin.settings.domain-config.update-analytics', $config->id) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">
                            Không bao gồm http:// hoặc https://, ví dụ: example.com
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-2 text-xs text-gray-500">
                            Ví dụ GA4 property ID: 123456789
                        </p>
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        @enderror
                        <p class="mt-2 text-xs text-gray-500">
                            Upload file JSON mới nếu cần thay thế. Bỏ trống để giữ file hiện tại.
                        </p>
                    </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit"
                        class="px-5 py-2.5 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition">
                    Cập nhật
                </button>
            </div>
        </form>
